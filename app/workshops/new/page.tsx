...
export default function NewWorkshopPage() {
  ...
  const loadDefaultTemplate = () => {
    const defaultSlides = vexlWorkshopTemplate.sections.map((section, index) => ({
      ...
      contacts: (section.content as any)?.contacts,
      offers: (section.content as any)?.offers,
      features: (section.content as any)?.features,
      bullets: (section.content as any)?.bullets,
      items: (section.content as any)?.items,
      showLogo: (section.content as any)?.showLogo,
      background: (section.content as any)?.background,
      stats: (section.content as any)?.stats,
      showAirDrop: (section.content as any)?.showAirDrop,
      comparison: (section.content as any)?.comparison,
      quote: (section.content as any)?.quote,
      author: (section.content as any)?.author,
      statistic: (section.content as any)?.statistic,
      content: (section.content as any)?.content,
      backgroundColor: (section.content as any)?.backgroundColor,
      ...section.content
    }));
